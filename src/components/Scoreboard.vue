    ...
    <div class="players">
      <div v-for="player of players" :key="player.id">
        <app-player
          ...
          :playerId="player.id"
          :score="player.score"
          @scoreWasChanged="updatePlayer (player.id, $event)"
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      updatePlayer (index, step) {
        console.log (index, step)
        this.$store.dispatch('updatePlayer', {index, step})
      ...
      selectPlayer(idPlayer) {
        this.$store.dispatch('selectPlayer', idPlayer)
      },
    },
    components: {
      'app-player': Player,
